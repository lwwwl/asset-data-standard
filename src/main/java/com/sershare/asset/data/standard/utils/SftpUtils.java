...
public class SftpUtils {
     ...
     * @since 2012.02.09
     */
    public static boolean copyFile(ChannelSftp channelSftp, String srcSftpFilePath, String distSftpFilePath) {
...
//                channelSftp.put(srcFtpFileStreams, distSftpFilePath);
            ...
            LOGGER.error("SftpException copy file fail scr:{},dist:{}", srcSftpFilePath, distSftpFilePath, e);
            return false;
        } catch (IOException e) {
            LOGGER.error("IOException copy file fail scr:{},dist:{}", srcSftpFilePath, distSftpFilePath, e);
            return false;
        }
        return true;
    }
    ...
    public static ByteArrayInputStream getByteArrayInputStreamFile(ChannelSftp channelSftp, String sftpFilePath) throws SftpException, IOException {
        if (existFile(channelSftp, sftpFilePath)) {
            byte[] srcFtpFileByte = inputStreamToByte(channelSftp.get(sftpFilePath));
